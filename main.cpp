...
public:
    ...
    void askForWar(){
        ...
        while(player1CardsToBid>queue2.size()||(player1CardsToBid>0&&player1CardsToBid<53))
        ...
        while(player2CardsToBid>queue2.size()||(player2CardsToBid>0&&player1CardsToBid<53))
        {
            cout<<"you don't have enough cards , you have only "<<queue1.size()<<" cards\n";
            cin>>player2CardsToBid;
        }
...
int main() {
    CardWarGame cardWarGame = CardWarGame();
